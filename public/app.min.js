...
"use strict";var ready=require("document-ready"),xtend=require("xtend"),GoogleMapsLoader=require("google-maps"),h=require("hyperscript"),localForage=require("localforage"),applyBindings=require("knockout/build/output/knockout-latest").applyBindings,fall=require("fastfall")(),FilteredLocationViewModel=require("./viewmodels/location"),Wikipedia=require("./models/wikipedia"),config=require("../../config.json"),LOCATIONS_KEY="locations",LS_SUPPORTED=localForage.supports(localForage.LOCALSTORAGE);GoogleMapsLoader.KEY=config.google_maps_api.key,GoogleMapsLoader.LANGUAGE=config.google_maps_api.language,GoogleMapsLoader.REGION=config.google_maps_api.region,localForage.config({driver:localForage.LOCALSTORAGE,name:"neighborhood-app"}),ready(function(){var e=document.querySelector("#map");if(!e)throw new Error("Map container not found. Unable to initialize google maps");fall([function(e){if(LS_SUPPORTED)return localForage.getItem(LOCATIONS_KEY,function(i,n){return!i&&n&&Array.isArray(n)?n.length!==config.default_locations.length?localForage.removeItem(LOCATIONS_KEY,function(i){e(i,config.default_locations,!1)}):void e(null,n,!0):(i instanceof Error&&console.error(i),e(null,config.default_locations,!1))});e(null,config.default_locations,!1)},function(e,i,n){if(i)return n(null,e,!0);var o=e.map(function(e){return e.wikipedia.pageid});Wikipedia.getDescriptions(o,function(i,o){if(i)return console.error(i),n(null,e,!0);n(null,e.map(function(e){return e.hasOwnProperty("wikipedia")?xtend(e,{wikipedia:{file:e.wikipedia.file,description:o[e.wikipedia.pageid]}}):e}),!1)})},function(e,i,n){if(i)return n(null,e,!0);var o=e.map(function(e){return e.wikipedia.file});Wikipedia.getImages(o,function(i,o){if(i)return console.error(i),n(null,e,!0);n(null,e.map(function(e){return e.hasOwnProperty("wikipedia")?xtend(e,{wikipedia:{description:e.wikipedia.description,image:o[e.wikipedia.file]}}):e}),!1)})},function(e,i,n){return i?n(null,e):LS_SUPPORTED?localForage.setItem(LOCATIONS_KEY,e,function(i){if(i)return n(i);n(null,e)}):void n(null,e)}],function(i,n){if(i)return window.alert(i.message+". Please reload the page");document.body.className="";var o=FilteredLocationViewModel(n);GoogleMapsLoader.load(function(i){var n={},a=new i.maps.Map(e,{center:config.center,zoom:11,fullscreenControl:!0});o.active.subscribe(function(e){Object.keys(n).forEach(function(r){var t=n[r];r===e?(t.setAnimation(i.maps.Animation.BOUNCE),t.infoWindow.open(a,t)):(t.infoWindow.close(),t.setAnimation(null)),i.maps.event.addListener(t.infoWindow,"closeclick",function(){t.setAnimation(null),o.select(null)})})}),o.filtered.subscribe(function(e){var i=e.map(function(e){return e.name});o.select(null),Object.keys(n).forEach(function(e){var o=n[e];-1===i.indexOf(e)?(o.infoWindow.close(),o.setAnimation(null),o.setVisible(!1)):o.setVisible(!0)})}),o.filtered().forEach(function(e){var r=new i.maps.Marker({title:e.name,position:e.coords,animation:i.maps.Animation.DROP}),t=h("div.infowindow",{},[h("h2",{},e.name),h("img",{rel:e.name,src:e.wiki.image}),h("p",{},e.wiki.description||"No information available")]);r.infoWindow=new i.maps.InfoWindow({content:t}),r.addListener("click",function(){o.select(e)}),r.setMap(a),n.hasOwnProperty(e.name)||(n[e.name]=r)}),applyBindings(o)})})});

},{"../../config.json":5,"./models/wikipedia":3,"./viewmodels/location":4,"document-ready":15,"fastfall":16,"google-maps":17,"hyperscript":18,"knockout/build/output/knockout-latest":21,"localforage":22,"xtend":26}],2:[function(require,module,exports){
"use strict";function Location(o,t,i){if(!(this instanceof Location))return new Location(o,t,i);this.name=o,this.coords=t,this.wiki=i}Location.create=function(o,t,i){return new Location(o,t,i)},module.exports=Location;

},{}],3:[function(require,module,exports){
"use strict";var jsonp=require("jsonp"),WIKIMEDIA_API_BASE="https://en.wikipedia.org/w/api.php";exports.getDescriptions=function(r,e){return Array.isArray(r)?jsonp(WIKIMEDIA_API_BASE+"?action=query&prop=extracts&exlimit=max&explaintext&exintro&format=json&pageids="+r.join("|"),function(r,n){if(r)return e(r);if(!n||!n.query)return e(new Error("Unexpected document result"));if(!n.query.hasOwnProperty("pages"))return e(new Error("Unexpected query result"));var t={};Object.keys(n.query.pages).forEach(function(r){var e=n.query.pages[r],i=parseInt(r,10)||-1;t[i]=e.extract}),e(null,t)}):e(new Error("pageids must be an array"))},exports.getImages=function(r,e){return Array.isArray(r)?jsonp(WIKIMEDIA_API_BASE+"?action=query&prop=imageinfo&iiprop=url&format=json&titles="+r.join("|"),function(r,n){if(r)return e(r);if(!n||!n.query)return e(new Error("Unexpected document result"));if(!n.query.hasOwnProperty("pages"))return e(new Error("Unexpected query result"));var t={};Object.keys(n.query.pages).forEach(function(r){var e=n.query.pages[r];Array.isArray(e.imageinfo)&&e.imageinfo.length>0&&(t[e.title]=e.imageinfo[0].url||null)}),e(null,t)}):e(new Error("files must be an array"))};

},{"jsonp":20}],4:[function(require,module,exports){
"use strict";var observable=require("knockout/build/output/knockout-latest").observable,observableArray=require("knockout/build/output/knockout-latest").observableArray,pureComputed=require("knockout/build/output/knockout-latest").pureComputed,arrayFilter=require("knockout/build/output/knockout-latest").utils.arrayFilter,Location=require("../models/location");function FilteredLocationViewModel(e){if(!(this instanceof FilteredLocationViewModel))return new FilteredLocationViewModel(e);var t=e.map(function(e){return Location.create(e.name,e.coords,e.wikipedia)});this.locations=observableArray(t),this.search=observable(""),this.active=observable(""),this.filtered=pureComputed(function(){var e=this.search();return e?arrayFilter(this.locations(),function(t){return t.name.toLowerCase().indexOf(e.toLowerCase())>-1}):this.locations()},this),this.select=function(e){this.active(e&&e.name?e.name:"")}.bind(this)}module.exports=FilteredLocationViewModel;

},{"../models/location":2,"knockout/build/output/knockout-latest":21}],5:[function(require,module,exports){
module.exports={
  "google_maps_api": {
  ...
  "default_locations": [
    {
      ...
      "wikipedia": {
        "pageid": 2178282,
        "file": "File:Lower platform at 12th Street - Oakland City Center, July 2017.JPG"
      }
    },
    {
      ...
      "wikipedia": {
        "pageid": 2146354,
        "file": "File:16thMission BART station.jpg"
      }
    },
    {
      ...
      "wikipedia": {
        "pageid": 2178402,
        "file": "File:19th Street-Oakland BART.jpg"
      }
    },
    {
      ...
      "wikipedia": {
        "pageid": 2146362,
        "file": "File:24th Street Mission Station 2976 14.JPG"
      }
    },
    {
      ...
      "wikipedia": {
        "pageid": 2204042,
        "file": "File:Ashby BART 2701.JPG"
      }
    },
    {
      "name": "Balboa Park Station",
      "coords": {
        "lat": 37.7216559,
        "lng": -122.4496645
      },
      "wikipedia": {
        "pageid": 2146435,
        "file": "File:Balboa Park Station.jpg"
      }
    },
    {
      ...
      "wikipedia": {
        "pageid": 2203389,
        "file": "File:Castro Valley station 2806 04.JPG"
      }
    }
  ]
}
...
},{"./support/isBuffer":8,"_process":24,"inherits":7}],10:[function(require,module,exports){
...
},{"indexof":19}],13:[function(require,module,exports){
(function (process){
...
"use strict";var assert=require("assert");function ready(e){assert.notEqual(typeof document,"undefined","document-ready only runs in the browser");var t=document.readyState;if("complete"===t||"interactive"===t)return setTimeout(e,0);document.addEventListener("DOMContentLoaded",function(){e()})}module.exports=ready;

},{"assert":6}],16:[function(require,module,exports){
"use strict";var reusify=require("reusify"),empty=[];function fastfall(e,l){Array.isArray(e)&&(l=e,e=null);var t=reusify(Holder);return l?function(){var c,r,n=t.get();n.release=a,n.list=l;var o=arguments.length-1;switch(n.context=this||e,n.callback=arguments[o]||noop,o){case 0:n.work();break;case 1:n.work(null,arguments[0]);break;case 2:n.work(null,arguments[0],arguments[1]);break;case 3:n.work(null,arguments[0],arguments[1],arguments[2]);break;case 4:n.work(null,arguments[0],arguments[1],arguments[2],arguments[3]);break;default:for((c=new Array(o+1))[0]=null,r=0;r<o;r++)c[r+1]=arguments[r];n.work.apply(null,c)}}:function(){var l=t.get();l.release=a,3===arguments.length?(l.context=arguments[0],l.list=arguments[1],l.callback=arguments[2]||noop):(l.context=e,l.list=arguments[0],l.callback=arguments[1]||noop);l.work()};function a(e){t.release(e)}}function noop(){}function Holder(){this.list=empty,this.callback=noop,this.count=0,this.context=void 0,this.release=noop;var e=this;this.work=function l(){if(arguments.length>0&&arguments[0])return e.callback.call(e.context,arguments[0]);var t,a,c,r=arguments.length;if(e.count<e.list.length)switch(c=e.list[e.count++],r){case 0:case 1:return c.call(e.context,l);case 2:return c.call(e.context,arguments[1],l);case 3:return c.call(e.context,arguments[1],arguments[2],l);case 4:return c.call(e.context,arguments[1],arguments[2],arguments[3],l);default:for(a=new Array(r),t=1;t<r;t++)a[t-1]=arguments[t];a[r-1]=l,c.apply(e.context,a)}else{switch(r){case 0:e.callback.call(e.context);break;case 1:e.callback.call(e.context,arguments[0]);break;case 2:e.callback.call(e.context,arguments[0],arguments[1]);break;case 3:e.callback.call(e.context,arguments[0],arguments[1],arguments[2]);break;case 4:e.callback.call(e.context,arguments[0],arguments[1],arguments[2],arguments[3]);break;default:for(a=new Array(r),t=0;t<r;t++)a[t]=arguments[t];e.callback.apply(e.context,a)}e.context=void 0,e.list=empty,e.count=0,e.release(e)}}}module.exports=fastfall;

},{"reusify":25}],17:[function(require,module,exports){
!function(n,e){if(null===n)throw new Error("Google-maps package can be used only in browser");"function"==typeof define&&define.amd?define(e):"object"==typeof exports?module.exports=e():n.GoogleMapsLoader=e()}("undefined"!=typeof window?window:null,function(){"use strict";var n=null,e=null,o=!1,l=[],t=[],i=null,u={URL:"https://maps.googleapis.com/maps/api/js",KEY:null,LIBRARIES:[],CLIENT:null,CHANNEL:null,LANGUAGE:null,REGION:null,VERSION:"3.31",WINDOW_CALLBACK_NAME:"__google_maps_api_provider_initializator__",_googleMockApiObject:{},load:function(n){null===e?!0===o?n&&l.push(n):(o=!0,window[u.WINDOW_CALLBACK_NAME]=function(){r(n)},u.createLoader()):n&&n(e)},createLoader:function(){(n=document.createElement("script")).type="text/javascript",n.src=u.createUrl(),document.body.appendChild(n)},isLoaded:function(){return null!==e},createUrl:function(){var n=u.URL;return n+="?callback="+u.WINDOW_CALLBACK_NAME,u.KEY&&(n+="&key="+u.KEY),u.LIBRARIES.length>0&&(n+="&libraries="+u.LIBRARIES.join(",")),u.CLIENT&&(n+="&client="+u.CLIENT),u.CHANNEL&&(n+="&channel="+u.CHANNEL),u.LANGUAGE&&(n+="&language="+u.LANGUAGE),u.REGION&&(n+="&region="+u.REGION),u.VERSION&&(n+="&v="+u.VERSION),n},release:function(r){var a=function(){u.KEY=null,u.LIBRARIES=[],u.CLIENT=null,u.CHANNEL=null,u.LANGUAGE=null,u.REGION=null,u.VERSION="3.31",e=null,o=!1,l=[],t=[],void 0!==window.google&&delete window.google,void 0!==window[u.WINDOW_CALLBACK_NAME]&&delete window[u.WINDOW_CALLBACK_NAME],null!==i&&(u.createLoader=i,i=null),null!==n&&(n.parentElement.removeChild(n),n=null),r&&r()};o?u.load(function(){a()}):a()},onLoad:function(n){t.push(n)},makeMock:function(){i=u.createLoader,u.createLoader=function(){window.google=u._googleMockApiObject,window[u.WINDOW_CALLBACK_NAME]()}}},r=function(n){var i;for(o=!1,null===e&&(e=window.google),i=0;i<t.length;i++)t[i](e);for(n&&n(e),i=0;i<l.length;i++)l[i](e);l=[]};return u});
...
},{"browser-split":11,"class-list":12,"html-element":10}],19:[function(require,module,exports){
...
var debug=require("debug")("jsonp");module.exports=jsonp;var count=0;function noop(){}function jsonp(e,n,o){"function"==typeof n&&(o=n,n={}),n||(n={});var t,r,u=n.prefix||"__jp",i=n.name||u+count++,c=n.param||"callback",p=null!=n.timeout?n.timeout:6e4,d=encodeURIComponent,a=document.getElementsByTagName("script")[0]||document.head;function m(){t.parentNode&&t.parentNode.removeChild(t),window[i]=noop,r&&clearTimeout(r)}return p&&(r=setTimeout(function(){m(),o&&o(new Error("Timeout"))},p)),window[i]=function(e){debug("jsonp got",e),m(),o&&o(null,e)},e=(e+=(~e.indexOf("?")?"&":"?")+c+"="+d(i)).replace("?&","?"),debug('jsonp req "%s"',e),(t=document.createElement("script")).src=e,a.parentNode.insertBefore(t,a),function(){window[i]&&m()}}

},{"debug":13}],21:[function(require,module,exports){
